...
WHERE V.id_vm = M.id_vm and T.date_time >= '2007-01-01 00:00:00' and T.date_time <= '2010-01-01 00:00:00' and T.id_time = M.id_time and
	(V.id_vm, M.mem_util) in 
		(SELECT id_vm, max(M.mem_util) 
		 FROM memory M, time_dim T
		 WHERE T.date_time >= '2007-01-01 10:00:00' and T.date_time <= '2011-01-01 10:00:00' and T.id_time = M.id_time
		 GROUP BY M.id_vm) 
