...
CREATE PROJECTION "cpu_DBD_10_seg_nuvem-design_nuvem-design" (
...
CREATE PROJECTION "cpu_DBD_9_seg_nuvem-design_nuvem-design" (
 id_cpu ENCODING AUTO, 
 id_time ENCODING AUTO, 
 id_vm ENCODING AUTO, 
 cpu_util ENCODING AUTO, 
...
select refresh('public.cpu');

CREATE PROJECTION "disk_DBD_7_seg_nuvem-design_nuvem-design" (
...
CREATE PROJECTION "disk_DBD_8_seg_nuvem-design_nuvem-design" (
 id_disk ENCODING AUTO, 
 id_time ENCODING AUTO, 
 id_vm ENCODING AUTO, 
 disk_util ENCODING AUTO, 
...
select refresh('public.disk');

CREATE PROJECTION "memory_DBD_11_seg_nuvem-design_nuvem-design" (
...
CREATE PROJECTION "memory_DBD_12_seg_nuvem-design_nuvem-design" (
 id_mem ENCODING AUTO, 
 id_time ENCODING AUTO, 
 id_vm ENCODING AUTO, 
 mem_util ENCODING AUTO, 
...
select refresh('public.memory');

CREATE PROJECTION "network_DBD_5_seg_nuvem-design_nuvem-design" (
...
CREATE PROJECTION "network_DBD_6_seg_nuvem-design_nuvem-design" (
 id_net ENCODING AUTO, 
 id_time ENCODING AUTO, 
 id_vm ENCODING AUTO, 
 net_util ENCODING AUTO, 
...
select refresh('public.network');

CREATE PROJECTION "time_dim_DBD_1_seg_nuvem-design_nuvem-design" (
 id_time ENCODING AUTO, 
...
CREATE PROJECTION "time_dim_DBD_2_seg_nuvem-design_nuvem-design" (
 id_time ENCODING AUTO, 
 date_time ENCODING AUTO
)
AS
...
select refresh('public.time_dim');

CREATE PROJECTION "vm_dim_DBD_3_seg_nuvem-design_nuvem-design" (
 id_vm ENCODING AUTO, 
...
CREATE PROJECTION "vm_dim_DBD_4_seg_nuvem-design_nuvem-design" (
 id_vm ENCODING AUTO, 
 vm_name ENCODING AUTO
)
AS
